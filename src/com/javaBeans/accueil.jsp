...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
              <h1 class="white">Au service de votre sant�</h1>
              <h3 style="color:antiquewhite"><b>
                �couter</b>,<b>Pr�server</b>,<b>Soigner</b></h3>
  ...
  <section id="doctor-team" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="ser-title">L'�quipe de notre cabinet</h2>
          <hr class="botm-line">
        </div>
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>Michel Donas</h3>
              <p><b>Medecin generaliste</b></p>
              <p>Tel: 078981314 <br>Email: Donas@hotmail.com</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>June Wells</h3>
              <p><b>Assistant medical</b></p>
              <p>Tel: 0615142526 <br>Email: June@hotmail.com</p>
              <ul class="list-inline">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
        ...
        <div class="col-md-3 col-sm-3 col-xs-6">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>Amanda Denyl</h3>
              <p><b>Secretaire </b></p>
              <p>Tel: 0615142526 <br>Email: Amanda@hotmail.com</p>
              <ul class="list-inline">
                <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                <li><a href="#"><i class="fa fa-google-plus"></i></a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-4">
          <h3>Contact Info</h3>
          <div class="space"></div>
          <p><i class="fa fa-map-marker fa-fw pull-left fa-2x"></i>157 William St, New York, <br> 10038, �tats-Unis</p>
          <div class="space"></div>
