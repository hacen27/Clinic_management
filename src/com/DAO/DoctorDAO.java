...
public class DoctorDAO implements DoctorService{
    ...
    public HomeData getData() {
        ...
        try {
            ...
            String userQuery = "SELECT COUNT(*) AS userNbr FROM patient";
            String apoinQuery = " SELECT COUNT(*)   AS  appointmentNbr FROM appointment";
            String nxtQuery = " SELECT COUNT(*)   AS  NxtAppointmentNbr FROM appointment WHERE date_of_appointment > SYSDATE()";
            String doneQuery = " SELECT COUNT(*)  AS  doneConsultations FROM  consultation";

            // queries for the chart in the bottom
            String janQuery = "SELECT COUNT(*) AS janQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-01-01' AND ConsultationDate < '"+thisYear+"-02-01'  ";
            String febQuery = "SELECT COUNT(*) AS febQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-02-01' AND ConsultationDate < '"+thisYear+"-03-01'  ";
            String marQuery = "SELECT COUNT(*) AS marQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-03-01' AND ConsultationDate < '"+thisYear+"-04-01'  ";
            String aprQuery = "SELECT COUNT(*) AS aprQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-04-01' AND ConsultationDate < '"+thisYear+"-05-01'  ";
            String maiQuery = "SELECT COUNT(*) AS maiQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-05-01' AND ConsultationDate < '"+thisYear+"-06-01'  ";
            String junQuery = "SELECT COUNT(*) AS junQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-06-01' AND ConsultationDate < '"+thisYear+"-07-01'  ";
            String julQuery = "SELECT COUNT(*) AS julQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-07-01' AND ConsultationDate < '"+thisYear+"-08-01'  ";
            String augQuery = "SELECT COUNT(*) AS augQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-08-01' AND ConsultationDate < '"+thisYear+"-09-01'  ";
            String sepQuery = "SELECT COUNT(*) AS sepQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-09-01' AND ConsultationDate < '"+thisYear+"-10-01'  ";
            String octQuery = "SELECT COUNT(*) AS octQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-10-01' AND ConsultationDate < '"+thisYear+"-11-01'  ";
            String novQuery = "SELECT COUNT(*) AS novQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-11-01' AND ConsultationDate < '"+thisYear+"-12-01'  ";
            String decQuery = "SELECT COUNT(*) AS decQuery FROM consultation WHERE date_of_consultation > '"+thisYear+"-12-01' AND ConsultationDate < '"+thisYear+"-01-01'  ";
	...
	public void setPreStat(PreparedStatement preStat) {
